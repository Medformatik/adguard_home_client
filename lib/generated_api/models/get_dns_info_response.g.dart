...
part of 'get_dns_info_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetDnsInfoResponse _$GetDnsInfoResponseFromJson(Map<String, dynamic> json) =>
    GetDnsInfoResponse(
      ...
      defaultLocalPtrUpstreams:
          (json['default_local_ptr_upstreams'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
    );

Map<String, dynamic> _$GetDnsInfoResponseToJson(GetDnsInfoResponse instance) =>
    <String, dynamic>{
      ...
      'default_local_ptr_upstreams': instance.defaultLocalPtrUpstreams,
    };
